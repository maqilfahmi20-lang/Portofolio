...
export default function ContactSection() {
  ...
  const handleDownloadCV = () => {
    // Create CV as a simple text/HTML download
    const cvContent = `
MUHAMMAD AQIL FAHMI
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-secondary text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors"
          >
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a href="https://linkedin.com/in/aqil-fahmi" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors" title="LinkedIn">
                ...
                <a href="https://github.com/aqilfahmi" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-200 text-gray-800 rounded-full flex items-center justify-center hover:bg-gray-800 hover:text-white transition-colors" title="GitHub">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
