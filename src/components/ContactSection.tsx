    ...
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          <a href={`mailto:${portfolioData.email}`} className="flex items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border-l-4 border-secondary">
            <div className="text-2xl text-secondary mr-3">📧</div>
            <div>
              <p className="font-semibold text-primary text-sm">Email</p>
              <p className="text-gray-600 text-sm">{portfolioData.email}</p>
            </div>
          </a>

          <a href={`https://wa.me/62${portfolioData.phone.substring(1)}?text=Halo%20Aqil`} target="_blank" rel="noopener noreferrer" className="flex items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border-l-4 border-green-500">
            <div className="text-2xl mr-3">💬</div>
            <div>
              <p className="font-semibold text-primary text-sm">WhatsApp</p>
              <p className="text-gray-600 text-sm">{portfolioData.phone}</p>
            </div>
          </a>
          ...
          <div className="flex items-center p-4 bg-white rounded-lg shadow-md border-l-4 border-blue-500">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">{portfolioData.location}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-10">
          <p className="font-semibold text-primary">Follow Me</p>
          <a href="https://linkedin.com/in/maqilf" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors" title="LinkedIn">
          ...
          <a href="https://github.com/maqilfahmi20-lang" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-200 text-gray-800 rounded-full flex items-center justify-center hover:bg-gray-800 hover:text-white transition-colors" title="GitHub">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
